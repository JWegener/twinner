...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col w-full max-w-md py-24 mx-auto stretch">
      <h1 className="text-3xl text-center mb-8">Rachel's Twin</h1>
          ...
          <div className="group relative mb-4 flex items-start md:-ml-12">
            <div className="flex h-8 w-8 shrink-0 select-none items-center justify-center rounded-md border shadow">
              {m.role === "user" ? (
                ...
                <img src="images/rachel-face.jpg" />
              )}
            </div>
      ...
      <form onSubmit={handleSubmit}>
        <input
          ...
          value={input}
          placeholder="Ask Rachel something...ex: how'd you sleep? Did you workout?"
